...
AddEventHandler('chase-fishing:client:useFishingBox', function(BoxId)
	...
	QBCore.Functions.Notify("WARNING.. WARNING.. WARNING..", "error")
	Wait(5000)
	QBCore.Functions.Notify("PLEASE BUY A BACKPACK ITEM IF YOU WOULD LIKE TO STORE MISC ITEMS!", "error")
	Wait(1000)
	QBCore.Functions.Notify("USE FOR ANYTHING OTHER THAN FISHING ITEMS WILL END IN A 24 HOUR BAN", "error")
